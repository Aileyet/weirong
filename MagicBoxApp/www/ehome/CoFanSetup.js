define(['text!ehome/CoFanSetup.html','../base/util', '../base/socketutil','../knobKnob/knobKnob.zepto',"../base/templates/template",'../base/tooltip/tooltip','../base/i18nMain'],
	function(viewTemplate,Util,SocketUtil,knobKnob,_TU,Tooltip,I18n) {
		var gatewayId="";
		var serial="";
		var check=null;
		var CoFan=null;
		...
		return Piece.View.extend({
			...
			onShow: function() {
				    this.onLoadTemplate();
					CoFan=Piece.Store.loadObject("CoFan", true);//添加到本地
					if(CoFan==null)
					{
						CoFan={power:0,oscillate:0,speed:0,ratio:0,time:null};
			...
			action:function(obj){
				...
				study=Piece.Cache.get("study");
				 if(study==1){
					  SocketUtil.StudyKey("FAN0",id);
					  Piece.Cache.put("study-key",id);  
					  Piece.Cache.put("study-module","FAN0");
			...
			setFan:function(id){
				switch(id)
				{
					...
					{ 	
						 ...
						 // }
						 // else{
							 // new Piece.Toast(I18n.ehome_CoFanSetup.timeError);
						 // }
						 break;
					}
					default:"";
