(function(a) {
    function t(j, b) {
        ...
        function m(a) {
            ...
            c = 1,
            b;
            for (b in $[a]) 0 == c % 20 && (j += '</div><div class="dw-bf">'),
            j += '<div class="dw-li dw-v" data-val="' + b + '" style="height:' + N + "px;line-height:" + N + 'px;"><div class="dw-i">' + $[a][b] + "</div></div>",
            c++;
            return j + "</div>"
        }
        function r(j) {
        ...
        function n(j, c, b, f, i) { ! 1 !== L("validate", [z, c, j]) && (a(".dw-ul", z).each(function(b) {
                var d = a(this),
                e = a('.dw-li[data-val="' + o.temp[b] + '"]', d),
                h = a(".dw-li", d),
                g = h.index(e),
                p = h.length,
                l = b == c || void 0 === c;
                if (!e.hasClass("dw-v")) {
                    for (var I = e,
                    m = 0,
                    r = 0; 0 <= g - m && !I.hasClass("dw-v");) m++,
                    I = h.eq(g - m);
                    for (; g + r < p && !e.hasClass("dw-v");) r++,
                    e = h.eq(g + r); (r < m && r && 2 !== f || !m || 0 > g - m || 1 == f) && e.hasClass("dw-v") ? g += r: (e = I, g -= m)
                }
                if (!e.hasClass("dw-sel") || l) o.temp[b] = e.attr("data-val"),
                a(".dw-sel", d).removeClass("dw-sel"),
                e.addClass("dw-sel"),
                o.scroll(d, b, g, l ? j: 0.1, l ? i: void 0)
            }), o.change(b))
        }
        function t(j) {
            if (! ("inline" == p.display || T === a(window).width() && ea === a(window).height() && j)) {
                ...
                W = I.outerWidth();
                Q = I.outerHeight(!0);
                "modal" == p.display ? (b = (T - W) / 2, e = j + (P - Q) / 2) : "bubble" == p.display ? (m = !0, h = a(".dw-arrw-i", z), b = f.offset(), i = b.top, g = b.left, d = f.outerWidth(), f = f.outerHeight(), b = g - (I.outerWidth(!0) - d) / 2, b = b > T - W ? T - (W + 20) : b, b = 0 <= b ? b: 20, e = i - Q, e < j || i > j + P ? (I.removeClass("dw-bubble-top").addClass("dw-bubble-bottom"), e = i + f) : I.removeClass("dw-bubble-bottom").addClass("dw-bubble-top"), h = h.outerWidth(), d = g + d / 2 - (b + (W - h) / 2), a(".dw-arr", z).css({
                    left: d > h ? h: d
        ...
        var ha, N, R, z, T, P, ea, W, Q, U, ia, o = this,
        fa = a.mobiscroll,
        S = j,
        F = a(S),
        aa,
        ...
        o.setValue = function(j, b, c, e) {
            a.isArray(o.temp) || (o.temp = p.parseValue(o.temp + "", o));
            V && j && n(c);
        ...
        o.changeWheel = function(j, b) {
            if (z) {
                ...
                for (e in p.wheels) for (f in p.wheels[e]) {
                    if ( - 1 < a.inArray(c, j) && ($[c] = p.wheels[e][f], a(".dw-ul", z).eq(c).html(m(c)), d--, !d)) {
                        t();
                        n(b, void 0, !0);
                        return
                    }
        ...
        o.show = function(j) {
            ...
            for (var d = '<div class="dw-trans ' + p.theme + " dw-" + p.display + '">' + ("inline" == p.display ? '<div class="dw dwbg dwi"><div class="dwwr">': '<div class="dw-persp"><div class="dwo"></div><div class="dw dwbg ' + f + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (p.headerText ? '<div class="dwv"></div>': "")), j = 0; j < p.wheels.length; j++) {
                d += '<div class="dwc' + ("scroller" != p.mode ? " dwpm": " dwsc") + (p.showLabel ? "": " dwhl") + '"><div class="dwwc dwrc"><table cellpadding="0" cellspacing="0"><tr>';
                for (e in p.wheels[j]) $[b] = p.wheels[j][e],
                d += '<td><div class="dwwl dwrc dwwl' + b + '">' + ("scroller" != p.mode ? '<div class="dwwb dwwbp" style="height:' + N + "px;line-height:" + N + 'px;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + N + "px;line-height:" + N + 'px;"><span>&ndash;</span></div>': "") + '<div class="dwl">' + e + '</div><div class="dww" style="height:' + p.rows * N + "px;min-width:" + p.width + 'px;"><div class="dw-ul">',
                d += m(b),
                d += '</div><div class="dwwo"></div></div><div class="dwwol"></div></div></td>',
                b++;
                d += "</tr></table></div></div>"
            }
            ...
            z.delegate(".dwwl", "DOMMouseScroll mousewheel",
            function(j) {
                if (!g(this)) {
                    j.preventDefault();
        ...
        o.hide = function(j, b) {
            ...
            350)) : (z.remove(), z = null), V = !1, ca = {},
            a(window).unbind(".dw"))
        };
        o.cancel = function() { ! 1 !== o.hide(!1, "cancel") && L("onCancel", [o.val])
        };
        o.init = function(a) {
            aa = G({
                defaults: {},
            ...
            o.settings = p;
            F.unbind(".dw");
            if (a = fa.presets[p.preset]) ba = a.call(S, o),
            G(p, ba, b),
            G(da, ba.methods);
            ...
            V && o.hide();
            "inline" == p.display ? o.show() : (k(), Y && p.showOnFocus && (F.data("dwro", S.readOnly), S.readOnly = !0, F.bind("focus.dw",
            function() {
                o.show()
            })))
        };
    ...
    function l(j, b, c, e, d) {
        ...
        i = void 0 === d ? b: d,
        h = C,
        l = e ? b == i ? 0.1 : Math.abs(0.1 * (b - i)) : 0;
    ...
    ka = {
        ...
        parseValue: function(a, b) {
            ...
            for (i = 0; i < c.length; i++) for (h in c[i]) {
                if (void 0 !== c[i][h][e[f]]) d.push(e[f]);
                else for (g in c[i][h]) {
                    d.push(g);
                    break
                }
    ...
    function() {
        if (h) {
            ...
            b = Math.round(D - d / i);
            if (!d && !E) {
                var g = Math.floor((x - g) / i),
                r = a(".dw-li", y).eq(g);
                d = c; ! 1 !== B.trigger("onValueTap", [r]) ? b = g: d = !0;
    ...
    a.mobiscroll.i18n.zh = a.extend(a.mobiscroll.i18n.hu, {
        setText: "确定",
        cancelText: "取消"
    })
})(jQuery); (function(a) {
    ...
    A = function(k) {
        ...
        K = v.match(/a/i),
        D = v.match(/h/),
        E = "datetime" == y ? f.dateFormat + f.separator + f.timeFormat: "time" == y ? f.timeFormat: f.dateFormat,
        c = new Date,
        b = f.stepHour,
        e = f.stepMinute,
        d = f.stepSecond,
        G = f.minDate || new Date(f.startYear, 0, 1),
        M = f.maxDate || new Date(f.endYear, 11, 31, 23, 59, 59);
        k.settings = f;
        q = q || E;
        if (y.match(/date/i)) {
            a.each(["y", "m", "d"],
            function(a, b) {
                h = C.search(RegExp(b, "i")); - 1 < h && B.push({
                    o: h,
                    v: b
                })
            });
            ...
            for (i = 0; 3 > i; i++) if (i == r.y) {
                ...
                s++;
                g[f.monthText] = {};
                for (h = 0; 12 > h; h++) J = C.replace(/[dy]/gi, "").replace(/mm/, 9 > h ? "0" + (h + 1) : h + 1).replace(/m/, h + 1),
                g[f.monthText][h] = J.match(/MM/) ? J.replace(/MM/, '<span class="dw-mon">' + f.monthNames[h] + "</span>") : J.replace(/M/, '<span class="dw-mon">' + f.monthNamesShort[h] + "</span>")
            } else if (i == r.d) {
                s++;
                g[f.dayText] = {};
        ...
        if (y.match(/time/i)) {
            ...
            a.each(["h", "i", "s", "a"],
            function(a, b) {
                a = v.search(RegExp(b, "i")); - 1 < a && B.push({
                    o: a,
                    v: b
                })
            });
            ...
            for (i = s; i < s + 4; i++) if (i == r.h) {
                ...
                s++;
                g[f.minuteText] = {};
                for (h = 0; 60 > h; h += e) g[f.minuteText][h] = v.match(/ii/) && 10 > h ? "0" + h: h
            } else if (i == r.s) {
                s++;
                g[f.secText] = {};
                    ...
                    if (r[d] !== void 0) {
                        ...
                        if (d == "d") {
                            ...
                            x && a(".dw-li", E).each(function() {
                                var b = a(this),
                                c = b.data("val"),
                                d = (new Date(s, n, c)).getDay(),
                                c = C.replace(/[my]/gi, "").replace(/dd/, c < 10 ? "0" + c: c).replace(/d/, c);
                        ...
                        if (d != "y") {
                            var A = a(".dw-li", E).index(a('.dw-li[data-val="' + e + '"]', E)),
                            J = a(".dw-li", E).index(a('.dw-li[data-val="' + l + '"]', E));
                        ...
                        if (f.invalid && d == "d") {
                            var t = [];
                            f.invalid.dates && a.each(f.invalid.dates,
                            function(a, b) {
                            ...
                            if (f.invalid.daysOfWeek) {
                                ...
                                v;
                                a.each(f.invalid.daysOfWeek,
                                function(a, b) {
                                    for (v = b - B; v < k; v = v + 7) v >= 0 && t.push(v)
                                })
                            }
                            f.invalid.daysOfMonth && a.each(f.invalid.daysOfMonth,
                            function(a, b) {
                                b = (b + "").split("/");
    ...
    t.formatDate = function(k, u, l) {
        ...
        n, l),
        m = function(a) {
            for (var g = 0; q + 1 < k.length && k.charAt(q + 1) == a;) g++,
            q++;
            return g
        },
        g = function(a, g, f) {
        ...
        i = "",
        f = !1;
        for (q = 0; q < k.length; q++) if (f)"'" == k.charAt(q) && !m("'") ? f = !1 : i += k.charAt(q);
        else switch (k.charAt(q)) {
        case "d":
            i += g("d", u.getDate(), 2);
            break;
        case "D":
    ...
    t.parseDate = function(k, u, l) {
        var m = new Date;
        if (!k || !u) return m;
        var u = "object" == typeof u ? u.toString() : u + "",
        g = a.extend({},
        n, l),
        t = g.shortYearCutoff,
        l = m.getFullYear(),
        ...
        r = -1,
        h = !1,
        w = function(a) { (a = x + 1 < k.length && k.charAt(x + 1) == a) && x++;
            return a
        },
        y = function(a) {
            w(a);
        ...
        C = function(a, g, f) {
            a = w(a) ? f: g;
            for (g = 0; g < a.length; g++) if (u.substr(v, a[g].length).toLowerCase() == a[g].toLowerCase()) return v += a[g].length,
            g + 1;
            return 0
        },
        v = 0,
        x;
        for (x = 0; x < k.length; x++) if (h)"'" == k.charAt(x) && !w("'") ? h = !1 : v++;
        ...
        if ( - 1 < f) {
            ...
            i = f;
            do {
                g = 32 - (new Date(l, q - 1, 32)).getDate();
                if (i <= g) break;
                q++;
                i -= g
            } while ( 1 )
    ...
    a.mobiscroll.i18n.hu = a.extend(a.mobiscroll.i18n.zh, {
    ...
    n = function(n) {
        ...
        function u(a, c, b) {
            ...
            for (e = 0; e < b.length;) b[e].invalid && g.push(b[e].key),
            e++;
            return g
        }
        function l(a, c) {
        ...
        function m(a, c, b) {
            ...
            d, f, i = [{}],
            h = v;
            if (c) for (d = 0; d < c; d++) i[d] = {},
            i[d][x[d]] = {};
            for (; e < a.length;) {
                i[e] = {};
                d = i[e];
                for (var c = x[e], k = h, l = {},
                m = 0; m < k.length;) l[k[m].key] = k[m++].value;
                d[c] = l;
                d = 0;
                ...
                if (void 0 !== c && h[c].children) e++,
                h = h[c].children;
                else if ((f = g(h)) && f.children) e++,
                h = f.children;
                else break
            }
            return i
        ...
        function g(a, c) {
            if (!a) return ! 1;
            for (var b = 0,
            e; b < a.length;) if (! (e = a[b++]).invalid) return c ? b - 1 : e;
            return ! 1
        }
        function H(g, c) {
            a(".dwc", g).css("display", "").slice(c).hide()
        }
        function q(a, c) {
            var b = [],
            e = v,
            ...
            if (void 0 !== a[d] && d <= c) {
                f = 0;
                i = a[d];
                for (h = void 0; f < e.length && void 0 === h;) e[f].key == a[d] && !e[f].invalid && (h = f),
                f++
            } else h = g(e, !0),
            i = e[h].key;
        ...
        x = function(a) {
            var c = [],
            b;
            for (b = 0; b < a; b++) c[b] = f.labels && f.labels[b] ? f.labels[b] : b;
            return c
        } (w),
        K = [],
        D = function(a) {
        ...
        return {
            ...
            onShow: function(g) {
                a(".dwwl", g).bind("mousedown touchstart",
                function() {
    ...
    a.mobiscroll.presets.select = function(k) {
        ...
        function O(a, b) {
            ...
            if (g) {
                var d = [],
                f = 0;
                for (f in k._selectedValues) d.push(C[f]),
                e.push(f);
                D.val(d.join(", "))
            } else D.val(a),
            e = b ? n(k.values[x]) : null;
        ...
        var r = a('label[for="' + H + '"]'),
        h = void 0 !== l.label ? l.label: r.length ? r.text() : m.attr("name"),
        w = [],
        y = [],
        C = {},
        v,
        ...
        O(C[q]);
        m.unbind(".dwsel").bind("change.dwsel",
        function() {
        ...
        return {
            ...
            parseValue: function() {
                ...
                s = i.index();
                f = s + "";
                return l.group && l.rtl ? ["_" + q, "_" + s] : l.group ? ["_" + s, "_" + q] : ["_" + q]
            },
            ...
            onValueTap: function(a) {
                if (g && a.hasClass("dw-v") && a.closest(".dw").find(".dw-ul").index(a.closest(".dw-ul")) == x) {
