	...
	function(viewTemplate,_TU,Util,SocketUtil,Schema,I18n) {
		...
		var setBtnColor=function(obj){
				if(obj.css("color")=="rgb(255, 255, 255)"){
							...
							obj.css("color",onBackgroundColor);
							obj.find("i").css("color",onBackgroundColor);
							//关闭
						}else{
							obj.css("backgroundColor",onBackgroundColor2);
							obj.css("color",diableColor2);
							obj.find("i").css("color",diableColor2);
							//打开
						}
		};
		//在存储的设备列表中按序列号查找设备
		...
		var fillDevice=function(item,btnhtml){
				...
				$("#ser_"+id).find(".div-slider").bind("tap",function(){
						...
						if($(this).find("div").css("float")=="left"){
							//$(this).parent().find(".view-box i").css("color","#fff");
							...
							//$(this).parent().find(".view-box i").css("color","#d0d0d0");
							$(this).css("backgroundColor","#dcdde0");
