                  ...
                  function(data, textStatus, jqXHR)
                  {
                        for(var i=0;i<data.modelList.length;i++){
                            ...
                            obj.bind("tap",function(){
                                  ...
                                  equipList[equipList.length]={"serial":guid,"device":Schema.DeviceCatg[deviceIndex].type,"name":"","gatewayId":gatewayId,"brandId":brandId,"moduleId":$(this).attr("data-option-moduleid")};
