                ...
                $("#tip").html(I18n.AutoMatch.loadGetSearchIndex);//设置启动提示语
                                ...
                                $("#btnOk").bind("tap",function(){//确定按钮
									...
									//else if(autoState==1){//确认状态
                                        ...
                                        equipList[equipList.length]={"serial":guid,"device":Schema.DeviceCatg[deviceIndex].type,"brandId":brandId,"baseCodeIndex":baseCodeIndex,"autoSearchId":autoSearchId,"name":"","gatewayId":gatewayId};
