define(['zepto'], function($) {
	...
	//var ip = "http://weironghz.vicp.cc:8899/MagicBox";
	//var ip = "http://125.118.61.131:8899/MagicBox";
	var ip = "http://192.168.0.138:8899/MagicBox";
//var ip ="http://115.195.55.93:8899/MagicBox"
	var OpenAPI = {
		...
		"addUserLogin":ip + "/action/oauth2/addUserLogin.do",
		 ...
		 "addThirdPartyUser":ip+"/action/dev/addThirdPartyUser.do",
		 "get_QQUser_info":"https://graph.qq.com/user/get_user_info",
		 "get_WBUser_info":"https://api.weibo.com/2/users/show.json",
		 "get_WXUser_info":"https://api.weixin.qq.com/sns/userinfo",
		 "get_WXoauth2":"https://api.weixin.qq.com/sns/oauth2/access_token"
	};
