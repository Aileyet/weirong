...
require.config({
    paths: {
		...
		// stomp websocket add wjl
		sockjs: 'piece/js/vendor/stomp-websocket/js/sockjs',
        //lib
        ...
        validation : 'piece/js/vendor/backbone/js/backbone-validation-amd',
        	
        fastclick: 'piece/js/vendor/fastclick/js/fastclick',
        canvasloader: 'piece/js/components/canvasloader',
        iScroll: 'piece/js/vendor/iscroll/js/iscroll',
        
        jq : 'piece/js/vendor/jquery/js/mobiscroll.zepto', 
        mobiscroll : 'piece/js/vendor/mobiscoller/js/mobiscroll.custom.min',
...
(function() {
    ...
    require(['zepto', "underscore", "backbone", "fastclick", "text", "i18n", "core/app", "components/components",
             "base/moment/moment+langs.min", "sockjs", "jq", "mobiscroll", "validation"],
        function($, _, Backbone, FastClick, text, i18n, App, Components,Moment) {
            moment.lang('zh-cn');
            Piece = Components;
            ...
            function yourCallbackFunction(){
            	...
            	var coverTooltip = $(".covering-layer-tooltip");
            	if(coverTooltip.length >=1){
            		coverTooltip.hide();
            		coverTooltip.find(".over-mag").hide();
            		coverTooltip.find(".bluetooth-connectioning").hide();
            		coverTooltip.find(".misc-menu").hide();
            		coverTooltip.find(".WIFI-Info-seting-tooltip").hide();
            		history.back();
            	}
            }
