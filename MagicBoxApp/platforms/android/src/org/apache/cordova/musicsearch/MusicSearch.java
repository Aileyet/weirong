...
System.out.println("开始查找歌曲...........");
		if (action.equals("musicSearch")) {
			...
			String lis =videoList();
			callbackContext.success(lis);
		} else {
			return false;
		}
	...
	public String videoList(){
        ...
        Cursor cursor = this.cordova.getActivity().getContentResolver().query(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, null, 
               null, null, MediaStore.Video.Media.DEFAULT_SORT_ORDER);
        if (cursor.moveToFirst()) {
		    do {
		    	lis+=cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.TITLE))+",";
		    	lis+=cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.SIZE))+",";
		    	lis+=cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.DATA))+"@@";
