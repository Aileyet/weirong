...
System.out.println("要停止的歌曲id="+args.getString(0));
...
System.out.println("准备获取当前播放位置......");
            float f = this.getCurrentPositionAudio(args.getString(0));
System.out.println("获取当前播放位置......f="+f);
...
//System.out.println("CreatePlayer  id="+id+"; file="+file);
...
System.out.println("开始播放出来id="+id+"; file="+file);
     	AudioPlayer audio = getOrCreatePlayer(id, file);
...
System.out.println("开始从指定的毫秒开始播放milliseconds="+milliseconds);
    	AudioPlayer audio = this.players.get(id);
        if (audio != null) {
System.out.println("audio存在，开始播放milliseconds="+milliseconds);
           audio.seekToPlaying(milliseconds);
System.out.println("指定播放结束");
        }
    }
...
System.out.println("进入stop处理.............id="+id);
    	AudioPlayer audio = this.players.get(id);
        if (audio != null) {
            audio.stopPlaying();
        }
...
System.out.println("获取当前播放位置......");
        if (audio != null) {
System.out.println("当前播放位置="+audio.getCurrentPosition()+"; 格式化后="+(audio.getCurrentPosition() / 1000.0f)+";");
