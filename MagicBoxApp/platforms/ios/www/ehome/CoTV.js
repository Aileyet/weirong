define(['text!ehome/CoTV.html','../base/util', '../base/socketutil','../base/tooltip/tooltip',"../base/templates/template",'../base/i18nMain'],
		...
		var check=null;
		var CoTv=null;
		var viewInitFun, setBtnColorFun, onMenuFn, getNewCustBtnNumFun, setDialogCssFun;;
		var study;
		var device=_TU._T.ehome_CoTV.device;
		...
		return Piece.View.extend({
			id: 'ehome_CoTV',
			events:{
			    'touchstart #power,#menu,#source,#up,#down,#left,#right,#ok,#volUp,#volDown,#mute,#Return,#chUp,#chDown,.custom-btn-div': 'action',
			...
			onShow: function() {
				...
				//设置中间"OK"的位置
				var yunW = $(".operating-disk-dot-zhong").width();
				var yunH = $(".operating-disk-dot-zhong").height();
