define(['text!magicbox/SeSubscribe.html',"zepto", "../base/openapi", '../base/util','../base/socketutil',"../base/templates/template"],
	function(viewTemplate, $, OpenAPI, Util,SocketUtil,_TU) {
		...
		var initView=function(){
			...
			$("#sd_type_dummy").val(subscribe.th_type == 1 ? "否" : "是");
			$("#wd_type_dummy").val(subscribe.temp_type == 1 ? "否" : "是");
			$("#dc_type_dummy").val(subscribe.dc_type == 1 ? "否" : "是");
			$("#kq_type_dummy").val(subscribe.kq_type == 1 ? "否" : "是");
			$("#hw_type_dummy").val(subscribe.hw_type == 1 ? "否" : "是");

			//$("#sd_type").val(subscribe.th_type);
			//$("#wd_type").val(subscribe.temp_type);
			//$("#hw_type").val(subscribe.hw_type);
			//$("#kq_type").val(subscribe.kq_type);
			//$("#dc_type").val(subscribe.dc_type);
		}
