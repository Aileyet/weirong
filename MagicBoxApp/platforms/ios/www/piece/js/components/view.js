define(['zepto', 'underscore', 'backbone', 'components/list', 'components/segment', 'components/carousel', 'components/extendable-list', 'components/session', 'components/base64Img', 'components/datepicker', 'components/fixed', '../base/components/footer-menu', '../base/components/nav-menu', '../base/components/my-nav-menu'],
    function($, _, Backbone, List, Segment, Carousel, ExtendableList, Session, Base64Img, Datepicker, Fixed, FooterMenu, NavMenu, MyNavHtml) {
        ...
        var CubeView = Backbone.View.extend({
            ...
            compile: function() {
                var me = this;
                var myNavHtml = MyNavHtml.compile(this.el);
                var footerMenu = FooterMenu.compile(this.el);
                var navMenu = NavMenu.compile(this.el);
