define(['zepto','../../base/i18nMain','../../base/templates/tempUtil','../../base/templates/templateIcon'], function($,I18n,_U,icon) {
	 var _T={
	 		 Color:{
	 		 	...
	 		 	sliderBgUnColor: icon.Color.sliderBgUnColor
	 		 },
			 home_MeIndex : {
					 ...
					 menus_1:[            //菜单集合 1
					        {
					        	...
					        	data_view: "Ehome?prePage=home/MeIndex",
					        	bgcolor:"menu-bg-pink"
					        },{
			 ...
			 home_MeFuncSet: {
				 ...
				 data:{
					 body:{
						 ...
						 oneKeySetting:I18n.MeFuncSet.oneKeySetting
					 },
					 menus:{
			 ...
			 ehome_CoProjector:{
				 ...
				 titleHide: I18n.ehome_CoProjector.titleHide,
				 rightIconHide: I18n.Common.save,
				 leftIcon:"&#xe661;", //头部左面图标
				 rightIcon:"&#xe641;",        //头部右面图标
				 device: "PRJ0",
			 ...
			 ehome_CoFanSetup:{
				 ...
				 data:{
					 ...
					 low: I18n.ehome_CoFanSetup.lowTxt,
					 mode: I18n.ehome_CoFanSetup.mode,
				     speed:I18n.ehome_CoFanSetup.speed
				 }
			 },
			 devicemanage_Ehome : {
			...
			ir_dev_list:{
					 ...
					 menus:[            //菜单集合 1
						   {
					        ...
					        },
					        {
								...
								isShow:true,
					        	name:I18n.IR_Iptv.name,              //菜单名称
					        	icon:"&#xe6a4;",
					        	type:I18n.IR_Iptv.type,
					        	data_module:"",            //跳转模块
					        	data_view:"",			   //跳转视图
					        	bgcolor:"" //菜单背景色
					        },
				 ...
				 menus:[            //菜单集合 1
					       {
                            ...
                            {
                            	isShow: false,
                            	name: I18n.IR_Study.name,              //菜单名称
                            	id: "9",
                            	icon: "&#xe6a8;",
                            	type: I18n.IR_Study.type,
                            	data_module: "",            //跳转模块
                            	data_view: "",			   //跳转视图
                            	bgcolor: "" //菜单背景色
                            },
			 ...
			 ehome_CoTV: {
				 ...
				 data:{
					 ...
					 mute_icon: "&#xe69e;",
					 return_icon: "&#xe64b;",
					 menu: I18n.ehome_CoTV.menu,
					 up_icon: "&#xe642;",
					 down_icon: "&#xe645;",
					 left_icon: "&#xe685;",
					 right_icon: "&#xe686;",
					 ok: I18n.ehome_CoTV.ok,
				 }
			 },
			 ehome_CoClean:{
				 id:'ehome_CoTV',    //页面ID
			 ...
			 ehome_CoSTB:{
				...
				data:{
					 ...
					 director_icon: "&#xe668;",
					 menu_icon: "&#xe64a;",
					 ok: I18n.ehome_CoSTB.ok,
				 }
			 },
			 ehome_CoIPTV:{
				 id:'ehome_CoIPTV',    //页面ID
				 remark:"IPTV",         //备注
				 title:I18n.ehome_CoIPTV.title,       //标题
				 titleHide:I18n.ehome_CoIPTV.titleHide,
				 leftIcon:"&#xe661;", //头部左面图标
				 rightIcon:"&#xe641;",        //头部右面图标
                 rightIconHide:I18n.Common.save,
                 device: "IPTV",
			...
			CoSetName:{
		     ...
		     dialog_Style:{
				 ...
				 choosed_icon: "&#xe69a;",
				 choosed_color: icon.Color.checkbarColor,
			 },
			 magicbox_VideoList:{
			 	 id:'scene_CoSetName',    //页面ID
				 remark:"",         //备注
				 title:I18n.magicbox_VideoList.title,       //标题
				 leftIcon:"&#xe661;", //头部左面图标
				 rightIcon:"",        //头部右面图标
			 },
			 home_OneKeyConfig:{
				 ...
				 remark:"一键设置",         //备注
				 title:I18n.home_OneKeyConfig.title,       //标题
				 leftIcon:"&#xe661;", //头部左面图标
				 rightIcon:"",        //头部右面图标
			 }
	 };
